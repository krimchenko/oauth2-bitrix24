...
class Bitrix24Test extends TestCase
{
    ...
    {
        $this->provider = new \League\OAuth2\Client\Provider\Bitrix24(
            [
                'domain' => 'https://bitrix.company.com',
    ...
    public function testGetBaseAccessTokenUrl(): void
    {
        ...
        $this->assertEquals('https://oauth.bitrix.info/oauth/token/', $url);
    }
    ...
    public function testBitrix24EnterpriseDomainUrls(): void
    {
        $this->provider->domain = 'https://bitrix.company.com';
        ...
        $providerAccessTokenUrl = 'https://oauth.bitrix.info/oauth/token/';
        $providerResourceOwnerUrl = $this->provider->domain . '/rest/user.current';
    ...
    public function testUserData(): void
    {
        ...
        $this->assertEquals($avatar, $user->toArray()['PERSONAL_PHOTO']);
    }
